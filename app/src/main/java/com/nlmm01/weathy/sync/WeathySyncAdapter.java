...
import com.nlmm01.weathy.MainActivity;
import com.nlmm01.weathy.R;
import com.nlmm01.weathy.Utility;
 ...
 */
public class WeathySyncAdapter extends AbstractThreadedSyncAdapter {
    public final String LOG_TAG = WeathySyncAdapter.class.getSimpleName();
    ...
    public WeathySyncAdapter(Context context, boolean autoInitialize) {
    ...
    private long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (locationCursor.moveToFirst()) {
            ...
            locationValues.put(LocationEntry.COLUMN_CITY, cityName);
    ...
    private static void onAccountCreated(Account newAccount, Context context) {
         ...
         */
        WeathySyncAdapter.configurePeriodicSync(context, SYNC_INTERVAL, SYNC_FLEXTIME);
