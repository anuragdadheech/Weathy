package com.nlmm01.weathy.service;
 ...
 */
public class WeathyService extends IntentService {
    private ArrayAdapter<String> mForecastAdapter;
    private Context mContext;
    public static final String LOCATION_QUERY_EXTRA = "lqe";
    private final String LOG_TAG = WeathyService.class.getSimpleName();

    public WeathyService() {
        super("WeathyService");
    }
    ...
    public static class AlarmReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            Intent sendIntent = new Intent(context, WeathyService.class);
            sendIntent.putExtra(WeathyService.LOCATION_QUERY_EXTRA, intent.getStringExtra(WeathyService.LOCATION_QUERY_EXTRA));
